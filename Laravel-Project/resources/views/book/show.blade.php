            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" readonly value="{{ $data['book']->title }}" name="title" class="form-control" placeholder="Գրքի անվանումը">
                            </div>
                            <div class="col-md-6">
                                <input type="text" readonly value="{{ $data['book']->price }}" name="price" class="form-control" placeholder="Գրքի գինը">
                            </div>
